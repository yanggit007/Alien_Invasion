...
for y_number in range(line_number):
    for x_number in range(column_number):
        ...
        alien_sprite.__doc__ = alien_sprite.rect.x
...
play_image = play_font.render('Play', True, settings.bg_color2, settings.bg_color3)
...
score_image = score_font.render(score_str, True, settings.bg_color2, settings.bg_color1)
...
high_score_image = high_score_font.render(high_score_str, True, settings.bg_color2, settings.bg_color1)
...
level_image = level_font.render(level_str, True, settings.bg_color2, settings.bg_color1)
...
while True:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_SPACE:
                if len(bullets) < settings.bullets_allowed:
                    ...
                    new_bullet.__doc__ = new_bullet.rect.y
    ...
    if ships_isleft > 0:
        ...
        for bullet in bullets:
            ...
            bullet.__doc__ -= settings.bullet_speed
            bullet.rect.y = bullet.__doc__
        ...
        for alien in aliens:
            alien.__doc__ += settings.alien_x_speed * alien_direction
            alien.rect.x = alien.__doc__
        ...
        pygame.draw.rect(screen_image, settings.bg_color3, button_rect)
